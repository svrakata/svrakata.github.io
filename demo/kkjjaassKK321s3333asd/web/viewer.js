...
function () {
  ...
  _createClass(PDFFindController, [{
    ...
    key: "_calculateMultiPhraseMatch",
    value: function _calculateMultiPhraseMatch(query, pageIndex, pageContent, entireWord) {
      var _this2 = this;

      var matchesWithLength = [];
      var queryArray = query.split('=');
      queryArray.forEach(function (e) {
        var queryLen = e.length;
        var matchIdx = -queryLen;

        while (true) {
          matchIdx = pageContent.indexOf(e, matchIdx + queryLen);

          if (matchIdx === -1) {
            break;
          }

          if (entireWord && !_this2._isEntireWord(pageContent, matchIdx, queryLen)) {
            continue;
          }
    ...
    value: function _calculateMatch(pageIndex) {
      ...
      var _this$_state = this._state,
          ...
          multiPhraseSearch = _this$_state.multiPhraseSearch;
      ...
      } else if (multiPhraseSearch) {
        this._calculateMultiPhraseMatch(query, pageIndex, pageContent, entireWord);
      } else {
      ...
      var _loop = function _loop(i, ii) {
        ...
        promise = promise.then(function () {
          return _this3._pdfDocument.getPage(i + 1).then(function (pdfPage) {
            ...
            _this3._pageContents[i] = normalize(strBuf.join(''));
